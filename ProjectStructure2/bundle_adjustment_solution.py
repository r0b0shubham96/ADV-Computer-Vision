...
def main():
    data_file = "/home/r0b0shubham96/Desktop/ADV Vision/ProjectStructure 2/data/problem-49-7776-pre/problem-49-7776-pre.txt.bz2"
    ...
    sparse_mat = bundle_adjustment_sparsity(n_cams, n_Qs, cam_idxs, Q_idxs)
