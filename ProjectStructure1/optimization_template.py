...
def evaluate_reprojection_error(Qs, qs_l, qs_r, cams):
    ...
    qs_l (ndarray): The left image points (those there was used to triangulated the 3D points). Given in shape (2, n)
    qs_r (ndarray): The right image points (those there was used to triangulated the 3D points). Given in shape (2, n)
    cams (StereoCameras): The two cameras
